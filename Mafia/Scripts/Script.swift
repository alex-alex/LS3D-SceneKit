...
enum ScriptCommandName: String {
	...
	case detectorWaitforhit = "detector_waitforhit"
	...
	case enemyGroupDel = "enemy_group_del"
	case enemyGroupNew = "enemy_group_new"
	case enemyLockstate = "enemy_lockstate"
	case enemyLook = "enemy_look"
	case enemyLookto = "enemy_lookto"
	case enemyMove = "enemy_move"
	case enemyMoveToCar = "enemy_move_to_car"
	case enemyNaserse = "enemy_naserse"
	case enemyPodvadimJak = "enemy_podvadim_jak"
	...
	case enemyUseDetector = "enemy_use_detector"
	...
	case humanFromcar = "human_fromcar"
